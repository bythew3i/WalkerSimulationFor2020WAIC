...
class Node
{
  ...
  private:
    ...
    void PublishMapPoints_CurrentFrame(std::vector<ORB_SLAM2::MapPoint*> map_points);
    ...
    sensor_msgs::PointCloud2 CurrentMapPointsToPointCloud (std::vector<ORB_SLAM2::MapPoint*> map_points);

    dynamic_reconfigure::Server<orb_slam2_ros::dynamic_reconfigureConfig> dynamic_param_server_;

    image_transport::Publisher rendered_image_publisher_;
    ros::Publisher map_points_publisher_;
    ros::Publisher map_points_current_publisher_;
